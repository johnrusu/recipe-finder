  ...
  <v-container class="about-page pb-0 mt-4">
    ...
    <v-card class="mb-6">
      <v-card-text class="pa-6">
        ...
        <p class="mb-6">
          {{ ABOUT_PAGE.DEVELOPER.BIO_2 }}
        </p>
        <div class="flex flex-wrap gap-3">
          <v-btn
            :href="ABOUT_PAGE.DEVELOPER.PORTFOLIO_URL"
            target="_blank"
            color="primary"
            prepend-icon="mdi-web"
          >
            {{ ABOUT_PAGE.DEVELOPER.PORTFOLIO }}
          </v-btn>
          <v-btn
            :href="ABOUT_PAGE.DEVELOPER.GITHUB_URL"
            target="_blank"
            color="grey-darken-3"
            prepend-icon="mdi-github"
          >
            {{ ABOUT_PAGE.DEVELOPER.GITHUB }}
          </v-btn>
          <v-btn
            :href="ABOUT_PAGE.DEVELOPER.LINKEDIN_URL"
            target="_blank"
            color="blue"
            prepend-icon="mdi-linkedin"
          >
            {{ ABOUT_PAGE.DEVELOPER.LINKEDIN }}
          </v-btn>
          <v-btn
            :href="ABOUT_PAGE.DEVELOPER.TOOLS_URL"
            target="_blank"
            color="blue"
            prepend-icon="mdi-tools"
          >
            {{ ABOUT_PAGE.DEVELOPER.TOOLS }}
          </v-btn>
        </div>
      </v-card-text>
    </v-card>
    ...
    <v-card>
      <v-card-text class="pa-6 text-center">
        ...
        <p class="mb-6">
          {{ ABOUT_PAGE.CONTACT.DESCRIPTION }}
        </p>
        <v-btn
          :href="ABOUT_PAGE.CONTACT.URL"
          target="_blank"
          color="primary"
          size="large"
